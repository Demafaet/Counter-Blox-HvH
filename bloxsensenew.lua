	...
	function UILibrary:Start(Parameters)
		...
		local function CreateColorThing(Parameters)
			...
			reUpdate = function(anim)
				...
				elseif anim == "Sine" then
					animationLoop = RunService.Stepped:Connect(function()
						local percentage = (tick() * (fakeFlagsShit["Sine"]["Speed"]["Value"] / 100) - math.floor(tick() * (fakeFlagsShit["Sine"]["Speed"]["Value"] / 100)))
						if percentage > 0.5 then
							percentage = percentage - 0.5
							Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Color"] = (fakeFlagsShit["Sine"]["Keyframe 2"]["Color"]:Lerp(fakeFlagsShit["Sine"]["Keyframe 1"]["Color"], math.sin(percentage * math.pi)))
							if Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] then
								local a = fakeFlagsShit["Sine"]["Keyframe 2"]["Transparency"]
								local b = fakeFlagsShit["Sine"]["Keyframe 1"]["Transparency"]
								local c = math.sin(percentage * math.pi)
								Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] = (a + (b - a)*c)
							end
						else
							Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Color"] = (fakeFlagsShit["Sine"]["Keyframe 1"]["Color"]:Lerp(fakeFlagsShit["Sine"]["Keyframe 2"]["Color"], math.sin(percentage * math.pi)))
							if Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] then
								local a = fakeFlagsShit["Sine"]["Keyframe 1"]["Transparency"]
								local b = fakeFlagsShit["Sine"]["Keyframe 2"]["Transparency"]
								local c = math.sin(percentage * math.pi)
				...
				elseif anim == "Pulse" then
					animationLoop = RunService.Stepped:Connect(function()
						local percentage = 0.5 * (1 - math.cos(2 * math.pi * tick() * (fakeFlagsShit["Pulse"]["Speed"]["Value"] / 100)))
						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Color"] = fakeFlagsShit["Pulse"]["Keyframe 1"]["Color"]:Lerp(fakeFlagsShit["Pulse"]["Keyframe 2"]["Color"], percentage)
						if Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] then
    						local a = fakeFlagsShit["Pulse"]["Keyframe 1"]["Transparency"]
    						local b = fakeFlagsShit["Pulse"]["Keyframe 2"]["Transparency"]
    						local c = percentage
    						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] = a + (b - a) * c
						end
					end)
				elseif anim == "MultiPulse" then
					animationLoop = RunService.Stepped:Connect(function()
						local percentage = (tick() * (fakeFlagsShit["MultiPulse"]["Speed"]["Value"] / 100) - math.floor(tick() * (fakeFlagsShit["MultiPulse"]["Speed"]["Value"] / 100)))
						if percentage > 0.8 then
    						percentage = percentage - 1
    						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Color"] = (fakeFlagsShit["MultiPulse"]["Keyframe 5"]["Color"]:Lerp(fakeFlagsShit["MultiPulse"]["Keyframe 4"]["Color"], math.sin(percentage * math.pi)))
    						if Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] then
        						local a = fakeFlagsShit["MultiPulse"]["Keyframe 5"]["Transparency"]
        						local b = fakeFlagsShit["MultiPulse"]["Keyframe 4"]["Transparency"]
        						local c = math.sin(percentage * math.pi)
        						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] = (a + (b - a)*c)
    						end
						elseif percentage > 0.6 then
    						percentage = percentage - 0.75
    						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Color"] = (fakeFlagsShit["MultiPulse"]["Keyframe 4"]["Color"]:Lerp(fakeFlagsShit["MultiPulse"]["Keyframe 3"]["Color"], math.sin(percentage * math.pi)))
    						if Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] then
        						local a = fakeFlagsShit["MultiPulse"]["Keyframe 4"]["Transparency"]
        						local b = fakeFlagsShit["MultiPulse"]["Keyframe 3"]["Transparency"]
        						local c = math.sin(percentage * math.pi)
        						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] = (a + (b - a)*c)
    						end
						elseif percentage > 0.4 then
    						percentage = percentage - 0.5
    						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Color"] = (fakeFlagsShit["MultiPulse"]["Keyframe 3"]["Color"]:Lerp(fakeFlagsShit["MultiPulse"]["Keyframe 2"]["Color"], math.sin(percentage * math.pi)))
    						if Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] then
        						local a = fakeFlagsShit["MultiPulse"]["Keyframe 3"]["Transparency"]
        						local b = fakeFlagsShit["MultiPulse"]["Keyframe 2"]["Transparency"]
        						local c = math.sin(percentage * math.pi)
        						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] = (a + (b - a)*c)
    						end
						elseif percentage > 0.2 then
    						percentage = percentage - 0.25
    						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Color"] = (fakeFlagsShit["MultiPulse"]["Keyframe 2"]["Color"]:Lerp(fakeFlagsShit["MultiPulse"]["Keyframe 1"]["Color"], math.sin(percentage * math.pi)))
    						if Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] then
        						local a = fakeFlagsShit["MultiPulse"]["Keyframe 2"]["Transparency"]
        						local b = fakeFlagsShit["MultiPulse"]["Keyframe 1"]["Transparency"]
        						local c = math.sin(percentage * math.pi)
        						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] = (a + (b - a)*c)
    						end
						else
    						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Color"] = (fakeFlagsShit["MultiPulse"]["Keyframe 1"]["Color"]:Lerp(fakeFlagsShit["MultiPulse"]["Keyframe 5"]["Color"], math.sin(percentage * math.pi)))
    						if Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] then
        						local a = fakeFlagsShit["MultiPulse"]["Keyframe 1"]["Transparency"]
        						local b = fakeFlagsShit["MultiPulse"]["Keyframe 5"]["Transparency"]
        						local c = math.sin(percentage * math.pi)
        						Menu[Parameters.Tab][Parameters.Section][Parameters.ObjectName]["Color " .. Parameters.Stance]["Transparency"] = (a + (b - a)*c)
    						end
						end
		...
		local function CreateKeyBindThing(Parented, Default, Tab, Section, ObjectName)
			...
			UILibrary:AddKeyBindList(string.format('%s: [Enabled]', ObjectName))
			local corresponding = KeyBindList[string.format('%s: [Enabled]', ObjectName)] 
			corresponding.Text = string.format('%s: [Disabled]', ObjectName)
			...
			corresponding.Text = string.format('%s: [Disabled]', thing)
					...
					UpdateConnection = RunService.Heartbeat:Connect(function()
						if Menu[Tab][Section][ObjectName]["Toggle"]["Enabled"] then
							if Menu[Tab][Section][ObjectName]["Bind"]["Activation Type"] == Options[4] then	
								...
								corresponding.Text = string.format('%s: [Enabled]', ObjectName)
							end
		...
		function UILibrary.Setwatermarkcheatname(text, user)
			local message = text .. "  |  " .. user .. "  |  " .. tostring(months[month]) .. " " .. tostring(day) .. " " .. tostring(year)	
			local fullsize = TextService:GetTextSize(message, UIStyle.HeaderFont.WatermarkTxtSize, UIStyle.HeaderFont.Font, Vector2.new(16000, 0))
			UILibrary.Watermark.Size = UDim2.new(0, fullsize.X + 24, 0, fullsize.Y + 8)
			WatermarkText.Text = message
		end
		...
		function UILibrary:CreateButton(Parameters)
			...
			Bool.Changed:Connect(function()
				...
				if Parameters.KeyBind then
					KeyBindList[string.format('%s: [Enabled]', Parameters.Name)].Visible = Menu[Parameters.Tab][Parameters.Section][Parameters.Name]["Toggle"]["Enabled"]
					if Parameters.Callback then
